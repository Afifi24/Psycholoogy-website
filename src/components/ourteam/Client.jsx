...
import {clientimghome} from '../../Animation'
const Client = () => {
  return (
    <div className='bg-[#FFFAF7] overflow-hidden'>
        <div className='mt-20 pt-10  flex-col lg:flex-row flex gap-10 items-start w-[90%] m-auto font-Manrope min-h-screen'>
           ...
           <motion.div variants={clientimghome} initial='hidden' whileInView={'show'} viewport={{once:true}} className='flex-1 relative'>
