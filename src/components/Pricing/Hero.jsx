  ...
  return (
    <div className='mt-20  font-Manrope mb-5'>
      <div className='w-[90%] m-auto min-h-screen'>
          ...
          <motion.p variants={textView} initial='hidden' whileInView={'show'} className='font-bold text-[#0E0E0E] mt-6 max-w-4xl text-4xl'>I offer a professional help to those who need either simple advice or require psychological treatment</motion.p>
